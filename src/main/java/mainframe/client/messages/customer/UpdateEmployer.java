...
public class UpdateEmployer implements Message {
    ...
    public UpdateEmployer(String customer, long id, String name, String position, double salary, String type) {
        _customer = customer;
        _id = id;
        _name = name;
        _position = position;
