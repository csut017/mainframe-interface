...
public class AddPhoneNumber implements Message {
    ...
    public AddPhoneNumber(boolean canTxt, String countryCode, String customer, boolean isPrimary, String number, String otherType, String type) {
        _canTxt = canTxt;
