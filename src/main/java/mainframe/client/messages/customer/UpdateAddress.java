...
public class UpdateAddress implements Message {
    ...
    public UpdateAddress(String city, String country, String customer, long id, boolean isMailing, boolean isPrimary, String line1, String line2, String otherType, String postCode, String suburb, String type) {
        _city = city;
        _country = country;
        _customer = customer;
        _id = id;
