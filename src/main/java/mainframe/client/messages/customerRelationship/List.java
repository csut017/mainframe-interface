...
public class List implements Message {
    ...
    public Status send(Connection connection) throws IOException
    {
        ...
        if (response.getStatus().getWasSuccessful()) {
            ...
            for (int i = 1; i <= itemsCount; i++) {
                ...
                String secondaryCustomerNumberValue = response.getValue(i + ":secondaryCustomerNumber");
                _data.add(new Item(idValue, secondaryCustomerNumberValue, typeValue));
            }
        }
    ...
    public class Item {
        ...
        public Item(long id, String secondaryCustomerNumber, String type) {
            _id = id;
