...
public class Create implements Message {
    ...
    public Create() {}
    public Create(String customerNumber, double paymentAmount, String paymentFrequency, double principal, double rateAmount, String rateFrequency, String rateType, String renewalDate, String startDate) {
